...
export const CartContextProvider = ({ children }: props) => {
    ...
    /* Delivery cost in ZAR */
    const shippingPrice = (): number => expressShipping ? 150 : 80;

    /* Total including 15% VAT + delivery */
    const getTotal = (): number => getSubtotal() * 1.15 + shippingPrice();
